			...
			if (in_array($tabelaLocal->TABLE_NAME, $arrayTabelasRemota)) {
				...
				foreach ($atributosTabelasDev as $atributosTabelaDev) {
					...
					if (!isset($atributosTabelasProd)) {
						...
						if(atributosTabelaDev->COLUMN_DEFAULT!==){
		...
		foreach ($tabelasLocal as $tabelaLocal) {
			...
			if (in_array($tabelaLocal->TABLE_NAME, $arrayTabelasRemota)) {
				...
				foreach ($atributosTabelasDev as $atributosTabelaDev) {
					...
					$atributosTabelasProd = $this->RotinasModel->atributosRemotaPorTabela2($atributosTabelaDev->TABLE_NAME, $atributosTabelaDev->COLUMN_NAME, $servidor, $login, $senha, $banco);
					...
					if ($atributosTabelaDev->TABLE_NAME == $atributosTabelaProd->TABLE_NAME) {

						if ($atributosTabelaProd->TABLE_NAME !== $atributosTabelaProd->DATA_TYPE) {

							print $atributosTabelaProd->TABLE_NAME . $atributosTabelaProd->DATA_TYPE;
						}
					}
