    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="data-form" class="pl-3 pr-3">
          <div class="row">
            <input type="hidden" id="codOrganizacao" name="codOrganizacao" class="form-control" placeholder="CodOrganizacao" required>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="descricao" class="col-form-label"> Descricao: <span class="text-danger">*</span> </label>
                <input type="text" id="descricao" name="descricao" class="form-control" placeholder="Descricao" minlength="0" maxlength="100" required>
              </div>
            </div>
          </div>
...
<script>
  ...
  function save(codOrganizacao) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof codOrganizacao === 'undefined' || codOrganizacao < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #descricao").val(response.descricao);
